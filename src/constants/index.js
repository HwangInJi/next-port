...
export const skillText = [
  {
    title: '기초를 다지다.',
    desc: '저는 어떤 일이든 튼튼한 기초가 성공의 열쇠라고 믿습니다. 지금도 새로운 도전을 할 때마다 기초를 단단히 다지는 데 집중하며, 프로그래밍을 배울 때도 기초 문법과 개념을 철저히 익혀 실력을 쌓았습니다. 앞으로도 저는 기초를 다지는 데 충실하며 꾸준히 성장해 나갈 것입니다.'
  },
  {
    title: '성취를 목표로 하다.',
    desc: '매일 새로운 도전을 향해 나아가며, 목표를 설정하고 이를 이루기 위해 꾸준히 노력합니다. 작은 성취를 통해 큰 성공을 이루며, 항상 더 나은 나를 만들기 위해 힘씁니다. 이 좌우명은 저를 움직이게 하는 원동력이자 삶의 지침입니다.'
  },
  {
    title: '최선을 다하다.',
    desc: '어떤 일이든 최선을 다하면 후회 없는 결과를 얻을 수 있다고 믿습니다. 매 순간, 주어진 일에 최선을 다하며 자신을 성장시키고 있습니다. 이 좌우명은 저에게 끊임없는 동기부여를 주며, 더 나은 미래를 향해 나아가게 합니다. 최선을 다하는 자세로 매일을 살아가고 있습니다.'
  }
]
...
export const contactText = [
  {
    ...
    title: 'KAKAO : dlswl1111'
  },
  {
    link: 'mailto:dlswl1993@gmail.com',
    title: 'mail : dlswl1993@gmail.com'
  }
]
